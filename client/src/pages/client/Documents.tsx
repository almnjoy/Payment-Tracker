...
import { FileText, Download, Eye, File, Loader2 } from "lucide-react";
import { motion } from "framer-motion";
import { useClientDocuments, formatDate } from "@/lib/api";
...
export default function ClientDocuments() {
  ...
  const handleDownload = (documentId: string) => {
    window.open(`/api/client/documents/${documentId}/download`, '_blank');
  };
