...
export function Layout({ children, role, clientName }: LayoutProps) {
  ...
  const clientLinks = [
    {
      ...
      label: "Dashboard",
      href: buildClientHref("/client/dashboard"),
    },
    {
      icon: CreditCard,
      label: "Payments",
      href: buildClientHref("/client/payments"),
    },
    {
      icon: FileText,
      label: "Documents",
      href: buildClientHref("/client/documents"),
    },
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex font-sans text-gray-900">
      ...
      >
        <div className="h-22 px-4 border-b border-gray-100 flex items-center">
          <div className="flex items-center gap-3">
            <img
              src="/logo-header.png"
              alt="Quick IT Projects"
          ...
          {role === "client"
            ...
            : // Admin Links (Grouped)
              adminGroups.map((group, groupIndex) => (
                <div
                  key={group.label}
                  className={cn("mb-6", groupIndex !== 0 && "pt-2")}
                >
                  {groupIndex !== 0 && (
                    <div className="mx-3 border-t border-gray-100 mb-4" />
                  )}
          ...
          <div className="flex items-center gap-3 px-3 py-2 mb-2">
            ...
            <div className="flex-1 min-w-0">
              <p className="text-sm font-medium text-gray-900 truncate">
                {role === "admin"
                  ? "Administrator"
                  : clientName || user?.firstName || "User"}
              </p>
